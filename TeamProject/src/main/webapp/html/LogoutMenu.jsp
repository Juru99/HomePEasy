...
<html>
  <head>
    ...
    <link rel="stylesheet" href="resources/css/Menu.css?ver=15" />
    <script>
    </script>
  </head>
  <body>
    <div class="logoutMenu-container">
      <div class="logoutMenu-left">
        <div class="logo">
      ...
      <div class="logoutMenu-right">
        <div class="login">
          <a href="BasePage.jsp?target_Main=html/Login">로그인</a>
        </div>
      </div>
    </div>
  </body>
